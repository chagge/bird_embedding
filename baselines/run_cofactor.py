...
#print('Read in data ...')
#train_data = pd.read_csv('../data/aggregated_obs_2014.csv')
#vad_data = pd.read_csv('../data/aggregated_obs_2013.csv')
#test_data = pd.read_csv('../data/aggregated_obs_2012.csv')
#
...
#
#print('Save sparse matrices to file...')
